...
|---|---|---|---|
| **U01** | — | — | ขอ **บัญชีบอทของ PocketBase** (ไม่ใช่บัญชีของคน) + Token A จาก dev · ยืนยัน Q-3 · เขียนวิธีเพิกถอน (revoke session ของบัญชีนั้น → token ทุกใบตายทันที) ลง `docs/runbooks/` |
