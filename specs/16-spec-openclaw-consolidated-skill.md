...
> attempts `npm install -g @chawengburi/bobby-cli` itself when missing, scoped only to
...
3. **(Amendment 4, 2026-07-24)** Step 0 changes from "check, and if
   ...
   **Why this three-command sequence and not something more elaborate:**
   ...
   `npm install -g @chawengburi/bobby-cli` are plain program invocations, valid
